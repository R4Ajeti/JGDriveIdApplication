...
public class MainActivity extends AppCompatActivity {
    ...
    private static String jgcodeNN="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String url = "https://drive.google.com/uc?export=download&id=11wtw6iY4rmeoAZzhsrodhFAop8CV-kEY";
            ...
            client.newCall(request).enqueue(new Callback() {
                ...
                public void onResponse(okhttp3.Call call, Response response) throws IOException {
                    if (response.isSuccessful()) {
                        ...
                        final String contentDisposition = response.header("expires");

                        MainActivity.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {

                                textMsg.setText(contentDisposition);
            ...
            */
            ...
            //whenSetResponseCache_thenCorrect(textMsg);
            ...
            String jgsource=jGDriveObject.jGSource(gurl, gid);
            ...
            //String jlinksource =jGDriveObject.getJLink(gurl, gid, jgcode);
            ...
            String jsource=jMegaDriveIdObject.jMegaSource(durl);
            ...
            final String url = "https://drive.google.com/uc?export=download&id=11wtw6iY4rmeoAZzhsrodhFAop8CV-kEY";
                ...
                client.newCall(request).enqueue(new Callback() {
                    ...
                    public void onResponse(okhttp3.Call call, Response response) throws IOException {
                        if (response.isSuccessful()) {
                            ...
                            final String contentDisposition = response.header("content-type");

                            JGDriveId jGDriveObject = new JGDriveId();
                            String jgcode123 = jGDriveObject.JGConfirmCode(myResponse, 4);
                            String jgurlN= url+"&confirm="+jgcode123;
                            ...
                            client2.newCall(request2).enqueue(new Callback() {
                                ...
                                public void onResponse(okhttp3.Call call, Response response) throws IOException {
                                    if (response.isSuccessful()) {
                                        final String content1 = response.header("location");
                                        MainActivity.this.runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
    ...
    public void  whenSetResponseCache_thenCorrect(TextView textMsg)
        ...
        //textMsg.setText(response1);

        Response response2 = client.newCall(request).execute();
        //textMsg.setText(response2);
    }
